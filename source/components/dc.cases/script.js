window.addEventListener('load', () => {
  ...
  const store = new Vuex.Store({
    ...
    actions: {
      ...
      setSessionStorage({ getters }) {
        ...
        window.sessionStorage.aasfilterTable = string;
      },
    },
  });
  ...
  Vue.component('formControlDate', {
    template: `<div class="b-float-label" data-src="${window.dcStore.paths.src}calendar.svg">
  ...
  const app = new Vue({
    ...
    beforeMount() {
      ...
      if (
        ...
        window.sessionStorage.aasfilterTable
      ) {
        queryObject = JSON.parse(window.sessionStorage.aasfilterTable);
      }
