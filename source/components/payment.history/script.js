window.addEventListener('load', () => {
  ...
  const store = new Vuex.Store({
    state() {
      return window.paymentHistoryStore;
    },
    mutations: {
    ...
    actions: {
      ...
      setSessionStorage({ getters }) {
        ...
        window.sessionStorage.aaspaymentHistory = string;
      },
    },
  });
  ...
  Vue.component('formControlDate', {
    template: `<div class="b-float-label" data-src="${window.paymentHistoryStore.paths.src}calendar.svg">
  ...
  const app = new Vue({
    ...
    beforeMount() {
      ...
      if (
        ...
        window.sessionStorage.aaspaymentHistory
      ) {
        queryObject = JSON.parse(window.sessionStorage.aaspaymentHistory);
      }
